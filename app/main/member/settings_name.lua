                ...
                content = function()
                    ui.field.popover {
                        attr = {
                            ...
                            datacontent = _ "In questa pagina puoi modificare il tuo nome pubblico. Il tuo nome vero non sarà modificato da questa impostazione e sarà comunque visibile nella pagina del tuo profilo.",
                            datahtml = "true",
                            class = "text-center"
                        },
                        content = function()
