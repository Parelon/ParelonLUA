...
ui.container {
  ...
  content = function()
    ...
    ui.container {
      attr = { class = "col-md-6 col-sm-7 col-xs-12 text-center well-inside spaceline spaceline-bottom"},
      content = function()
        ui.heading { attr = { class = "spaceline"}, level = 3, content = _ "You are in the area:" }
        local area_id = area.id
        local name = area.name
        ui.heading { attr = { class = "spaceline-bottom"}, level = 1, content = name }
      end
    }
    ui.container {
