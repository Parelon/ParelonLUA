      ...
      content = function()
        ...
        ui.container {
          ...
          content = function()
            ui.heading {
              level = 1,
              content = _ "Initiatives differences"
            }
          end
        }
        ui.container {
...
ui.container {
  ...
  content = function()
    ui.container {
      attr = { class = "col-md-3" },
      content = function()
        ui.heading { level = 3, attr = { class = "label label-warning" }, content = _ "Differences" }
      end
    }
  end
}
ui.container {
  ...
  content = function()
    if not status then
      ui.field.text { value = _ "The initiatives do not differ" }
    else
      ui.container {
        tag = "div",
