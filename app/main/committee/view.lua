        ...
        ui.container {
            ...
            content = function()
                ui.container {
                    attr = { class = "row-fluid" },
                    content = function()
                        ui.image { attr = { class = "span3 offset1" }, static = "png/committee_big.png" }
                        ui.container {
                            attr = { class = "span6 offset1 text-center spaceline3" },
                            content = function()
                                ui.container {
                                    attr = { class = "row-fluid label label-warning" },
                                    content = function()
                        ...
                        ui.container {
                            attr = { class = "row-fluid" },
                            content = function()
                                ui.image { attr = { class = "span12", }, static = "png/commission_step_1.png" }
                            end
                        }
                    end
                }
