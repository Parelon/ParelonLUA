...
local resourcesvid = Resource:by_initiative_id_and_type(initiative_id, "playlist_video_url")
local resourcessoc = Resource:by_initiative_id_and_type(initiative_id, "social_url")
        ...
        ui.container {
          ...
          content = function()
            ui.container {
              ...
              content = function()  
                for i=1,Resource:count_by_type(initiative_id, "archive_url") do
                  ui.container {
                    attr = { class = "row" },
                    content = function()
                ...
                for i=1,Resource:count_by_type(initiative_id, "open_data_url") do
                  ui.container {
                    attr = { class = "row spaceline" },
                    content = function()
                ...
                for i=1,Resource:count_by_type(initiative_id, "playlist_video_url") do
                  ui.container {
                    attr = { class = "row spaceline" },
                    content = function()
                ...
                for i=1,Resource:count_by_type(initiative_id, "social_url") do
                  ui.container {
                    attr = { class = "row spaceline" },
                    content = function()
