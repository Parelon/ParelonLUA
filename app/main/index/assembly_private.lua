      ...
      content = function()
        ...
        ui.container {
          ...
          content = function()
            ...
            ui.heading { level = 6, content = _("#{realname}, you are now in #{somewhere private}", { realname = (app.session.member.realname and app.session.member.realname or app.session.member.login) }) }
