...
local auth_needed = not ((module == 'index'
    and (view == "index"
      or view == "login"
      or action == "login"
      or view == "register"
...
if app.session:has_access("anonymous") then
  if ((module == "area" and view == "show") or
    (module == "unit" and view == "show") or
    (module == "policy" and view == "show") or
    (module == "policy" and view == "list") or
    (module == "issue" and (view == "show_ext_bs" or view == "show")) or
    (module == "initiative" and view == "show") or
    (module == "suggestion" and view == "show") or
    (module == "draft" and view == "diff") or
    (module == "draft" and view == "show") or
    (module == "draft" and view == "list") or
    (module == "index" and view == "search") or
    (module == "index" and view == "usage_terms"))
  then
    auth_needed = false
  end
end
